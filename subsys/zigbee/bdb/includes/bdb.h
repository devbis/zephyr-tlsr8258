...
#define	BDBC_MIN_COMMISSIONING_TIME             (180)   //!< the minimum duration in seconds for which a network is opened to allow new nodes to join or for a device to identify itself
